...
module.exports = {
  ...
  apps: {
    'ios.debug': {
      type: 'ios.app',
      binaryPath:
        'ios/build/Build/Products/Debug-iphonesimulator/FlipCardGame.app',
      build:
        'xcodebuild -workspace ios/FlipCardGame.xcworkspace -scheme FlipCardGame -configuration Debug -sdk iphonesimulator -derivedDataPath ios/build',
